...
def handle_calculate_IK(req):
    ...
    if len(req.poses) < 1:
        ...
        px, py, pz = symbols('px py pz') # end effector positions

        theta1, theta2, theta3, theta4, theta5, theta6 = 0, 0, 0, 0, 0, 0
        theta_prev = (0,0,0,0,0,0)
        ...
        ROT_EE_sym = ROT_EE_sym * ROT_ERROR
        ...
        for x in xrange(0, len(req.poses)):
            ...
            ROT_EE = ROT_EE_sym.subs({'r': roll, 'p': pitch, 'y': yaw})
            ...
            # use transpose() instead of inv("LU)"
